...
func search_location(location string, cache *Cache) ExploreResults {
...
func get_pokemon(name string, cache *Cache) Pokemon {
...
func get_locations(c *Config, np string, cache *Cache) Results {
