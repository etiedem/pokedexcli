...
func search_location(location string, cache *pokecache.Cache) ExploreResults {
...
func get_pokemon(name string, cache *pokecache.Cache) pokeconfig.Pokemon {
...
func get_locations(c *pokeconfig.Config, np string, cache *pokecache.Cache) Results {
